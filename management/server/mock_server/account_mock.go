...
type MockAccountManager struct {
	...
	SetPeerMeshLinksFunc                  func(ctx context.Context, accountID, peerID, userID string, links []nbpeer.MeshLink) (*nbpeer.Peer, error)
...
// SetPeerMeshLinks mocks SetPeerMeshLinks of the AccountManager interface
func (am *MockAccountManager) SetPeerMeshLinks(ctx context.Context, accountID, peerID, userID string, links []nbpeer.MeshLink) (*nbpeer.Peer, error) {
	if am.SetPeerMeshLinksFunc != nil {
		return am.SetPeerMeshLinksFunc(ctx, accountID, peerID, userID, links)
	}
	return nil, status.Errorf(codes.Unimplemented, "method SetPeerMeshLinks is not implemented")
}
