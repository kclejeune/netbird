...
type Body struct {
	...
	// linkId identifies which transport link this ICE negotiation is for.
	// Empty string means legacy single-link mode.
	LinkId        string `protobuf:"bytes,11,opt,name=linkId,proto3" json:"linkId,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_signalexchange_proto_rawDesc = "" +
	...
	"\x04body\x18\x04 \x01(\v2\x14.signalexchange.BodyR\x04body\"\xfc\x03\n" +
	"\x04Body\x12-\n" +
	...
	"\x0frosenpassConfig\x18\a \x01(\v2\x1f.signalexchange.RosenpassConfigR\x0frosenpassConfig\x12.\n" +
	"\x12relayServerAddress\x18\b \x01(\tR\x12relayServerAddress\x12!\n" +
	"\tsessionId\x18\n" +
	" \x01(\fH\x00R\tsessionId\x88\x01\x01\x12\x16\n" +
	"\x06linkId\x18\v \x01(\tR\x06linkId\"C\n" +
	"\x04Type\x12\t\n" +
