...
type RemotePeerConfig struct {
	...
	// links contains per-link transport configurations for multi-link mesh.
	// Empty for single-link (legacy) mode.
	Links         []*LinkConfig `protobuf:"bytes,6,rep,name=links,proto3" json:"links,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RemotePeerConfig) GetLinks() []*LinkConfig {
	if x != nil {
		return x.Links
	}
	return nil
...
// LinkConfig describes a single transport link to a remote peer.
// Each peer may be reachable over multiple links (e.g., WAN, Silvus MANET).
type LinkConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Unique identifier for this link (e.g., "wan0", "silvus0").
	LinkId string `protobuf:"bytes,1,opt,name=linkId,proto3" json:"linkId,omitempty"`
	// Transport type: "wireguard", "relay", or a custom transport plugin name.
	TransportType string `protobuf:"bytes,2,opt,name=transportType,proto3" json:"transportType,omitempty"`
	// Endpoint address for this link (host:port or multicast group).
	Endpoint string `protobuf:"bytes,3,opt,name=endpoint,proto3" json:"endpoint,omitempty"`
	// Link-specific MTU. 0 means use default.
	Mtu uint32 `protobuf:"varint,4,opt,name=mtu,proto3" json:"mtu,omitempty"`
	// Priority for path selection (lower = preferred). 0 is highest priority.
	Priority uint32 `protobuf:"varint,5,opt,name=priority,proto3" json:"priority,omitempty"`
	// Cost metric for routing protocol integration (e.g., Babel).
	Cost uint32 `protobuf:"varint,6,opt,name=cost,proto3" json:"cost,omitempty"`
	// WireGuard interface name to use for this link (if transport is wireguard).
	WgIfaceName string `protobuf:"bytes,7,opt,name=wgIfaceName,proto3" json:"wgIfaceName,omitempty"`
	// Whether this link supports multicast discovery.
	MulticastEnabled bool `protobuf:"varint,8,opt,name=multicastEnabled,proto3" json:"multicastEnabled,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *LinkConfig) GetTransportType() string {
	if x != nil {
...
func (x *LinkConfig) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *LinkConfig) GetMtu() uint32 {
	if x != nil {
		return x.Mtu
	}
	return 0
...
func (x *LinkConfig) GetPriority() uint32 {
	if x != nil {
		return x.Priority
	}
	return 0
...
func (x *LinkConfig) GetCost() uint32 {
	if x != nil {
		return x.Cost
	}
	return 0
...
func (x *LinkConfig) GetWgIfaceName() string {
	if x != nil {
		return x.WgIfaceName
	}
	return ""
}

func (x *LinkConfig) GetMulticastEnabled() bool {
	if x != nil {
		return x.MulticastEnabled
	}
	return false
}

// LinkStatusUpdate reports the health of a specific link from a peer.
type LinkStatusUpdate struct {
	...
	LatencyMs uint32 `protobuf:"varint,3,opt,name=latencyMs,proto3" json:"latencyMs,omitempty"`
	// Packet loss percentage (0-100).
	LossPercent uint32 `protobuf:"varint,4,opt,name=lossPercent,proto3" json:"lossPercent,omitempty"`
	// Available bandwidth in kbps (0 = unknown).
	BandwidthKbps uint64 `protobuf:"varint,5,opt,name=bandwidthKbps,proto3" json:"bandwidthKbps,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LinkStatusUpdate) Reset() {
	*x = LinkStatusUpdate{}
...
func (x *LinkStatusUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkStatusUpdate) ProtoMessage() {}

func (x *LinkStatusUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[54]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkStatusUpdate.ProtoReflect.Descriptor instead.
func (*LinkStatusUpdate) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{54}
}

func (x *LinkStatusUpdate) GetLinkId() string {
	if x != nil {
		return x.LinkId
	}
	return ""
...
func (x *LinkStatusUpdate) GetUp() bool {
	if x != nil {
		return x.Up
	}
	return false
...
func (x *LinkStatusUpdate) GetLatencyMs() uint32 {
	if x != nil {
		return x.LatencyMs
	}
	return 0
...
func (x *LinkStatusUpdate) GetLossPercent() uint32 {
	if x != nil {
...
func (x *LinkStatusUpdate) GetBandwidthKbps() uint64 {
	if x != nil {
...
const file_management_proto_rawDesc = "" +
	...
	"\aindexes\x18\x01 \x03(\rR\aindexes\"\xe9\x01\n" +
	...
	"\x05links\x18\x06 \x03(\v2\x16.management.LinkConfigR\x05links\"~\n" +
	"\tSSHConfig\x12\x1e\n" +
	"\n" +
	...
	"\x12StopExposeResponse\"\xf6\x01\n" +
	"\n" +
	"LinkConfig\x12\x16\n" +
	"\x06linkId\x18\x01 \x01(\tR\x06linkId\x12$\n" +
	"\rtransportType\x18\x02 \x01(\tR\rtransportType\x12\x1a\n" +
	"\bendpoint\x18\x03 \x01(\tR\bendpoint\x12\x10\n" +
	"\x03mtu\x18\x04 \x01(\rR\x03mtu\x12\x1a\n" +
	"\bpriority\x18\x05 \x01(\rR\bpriority\x12\x12\n" +
	"\x04cost\x18\x06 \x01(\rR\x04cost\x12 \n" +
	"\vwgIfaceName\x18\a \x01(\tR\vwgIfaceName\x12*\n" +
	"\x10multicastEnabled\x18\b \x01(\bR\x10multicastEnabled\"\xa0\x01\n" +
	"\x10LinkStatusUpdate\x12\x16\n" +
	"\x06linkId\x18\x01 \x01(\tR\x06linkId\x12\x0e\n" +
	"\x02up\x18\x02 \x01(\bR\x02up\x12\x1c\n" +
	"\tlatencyMs\x18\x03 \x01(\rR\tlatencyMs\x12 \n" +
	"\vlossPercent\x18\x04 \x01(\rR\vlossPercent\x12$\n" +
	"\rbandwidthKbps\x18\x05 \x01(\x04R\rbandwidthKbps*:\n" +
	"\tJobStatus\x12\x12\n" +
...
var file_management_proto_goTypes = []any{
	...
	(*LinkConfig)(nil),                     // 60: management.LinkConfig
	(*LinkStatusUpdate)(nil),               // 61: management.LinkStatusUpdate
	nil,                                    // 62: management.SSHAuth.MachineUsersEntry
	(*PortInfo_Range)(nil),                 // 63: management.PortInfo.Range
...
var file_management_proto_depIdxs = []int32{
	...
	64, // 19: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	65, // 26: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	...
	62, // 39: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	36, // 40: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	60, // 41: management.RemotePeerConfig.links:type_name -> management.LinkConfig
	28, // 42: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	6,  // 43: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	41, // 44: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	41, // 45: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	46, // 46: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	44, // 47: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	45, // 48: management.CustomZone.Records:type_name -> management.SimpleRecord
	47, // 49: management.NameServerGroup.NameServers:type_name -> management.NameServer
	...
	51, // 53: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	63, // 54: management.PortInfo.range:type_name -> management.PortInfo.Range
	...
	51, // 57: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	1,  // 58: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	51, // 59: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	51, // 60: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	4,  // 61: management.ExposeServiceRequest.protocol:type_name -> management.ExposeProtocol
	34, // 62: management.SSHAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	7,  // 63: management.ManagementService.Login:input_type -> management.EncryptedMessage
	7,  // 64: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	23, // 65: management.ManagementService.GetServerKey:input_type -> management.Empty
	23, // 66: management.ManagementService.isHealthy:input_type -> management.Empty
	7,  // 67: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	7,  // 68: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	7,  // 69: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	7,  // 70: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	7,  // 71: management.ManagementService.Job:input_type -> management.EncryptedMessage
	7,  // 72: management.ManagementService.CreateExpose:input_type -> management.EncryptedMessage
	7,  // 73: management.ManagementService.RenewExpose:input_type -> management.EncryptedMessage
	7,  // 74: management.ManagementService.StopExpose:input_type -> management.EncryptedMessage
	7,  // 75: management.ManagementService.Login:output_type -> management.EncryptedMessage
	7,  // 76: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	22, // 77: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	23, // 78: management.ManagementService.isHealthy:output_type -> management.Empty
	7,  // 79: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	7,  // 80: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	23, // 81: management.ManagementService.SyncMeta:output_type -> management.Empty
	23, // 82: management.ManagementService.Logout:output_type -> management.Empty
	7,  // 83: management.ManagementService.Job:output_type -> management.EncryptedMessage
	7,  // 84: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	7,  // 85: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	7,  // 86: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
